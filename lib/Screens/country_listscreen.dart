...
import 'package:my_first_project/Screens/country_detail.dart';
import 'package:my_first_project/models/country.dart';
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(country.name!, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
                              ],
                            ),
                          ),
                        ),
